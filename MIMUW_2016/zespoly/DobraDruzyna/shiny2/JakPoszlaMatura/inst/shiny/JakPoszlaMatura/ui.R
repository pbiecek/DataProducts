    ...
    class="con",
     sidebarLayout(
       sidebarPanel(
         ...
         # br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),
         # br(),br(),br(),br(),
         # h3("Bezrobocie w Twojej gminie w wybranym roku:"),
         # h2(textOutput("srednia_bezrobocie"), align = "center"),
         # h3("Jaki procent gmin w Polsce miał niższe bezrobocie?"),
         # h2(textOutput("liczba_bezrobocie"), align = "center"),
         # br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),
         # br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),
         # br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),
         # h3("Liczba mieszkańców na bibliotekę w Twojej gminie w wybranym roku:"),
         # h2(textOutput("srednia_biblioteki"), align = "center"),
         # h3("Jaki procent gmin w Polsce miał niższą liczbę mieszkańców na bibliotekę?"),
         # h2(textOutput("liczba_biblioteki"), align = "center"),
         # br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),
         # br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),
         # br(),br(),br(),br(),br(),br(),br(),br(),br(),
         # h3("Liczba czytelników bibliotek na 1000 osób w Twojej gminie w wybranym roku:"),
         # h2(textOutput("srednia_biblioteki"), align = "center"),
         # h3("Jaki procent gmin w Polsce miał więcej czytelników?"),
         # h2(textOutput("liczba_czytelnicy"), align = "center"),
         # br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),
         # br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),
         # br(),br(),br(),br(),br(),br(),br(),br(),br(),
         # h3("Liczba wypożyczeń książek na 1 czytelnika w Twojej gminie w wybranym roku:"),
         # h2(textOutput("srednia_wypozyczenia"), align = "center"),
         # h3("Jaki procent gmin w Polsce miał więcej wypożyczeń?"),
         # h2(textOutput("liczba_wypozyczenia"), align = "center")
       ),
