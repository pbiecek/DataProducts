...
Obliczenia te wykonywane są przez funkcję zaladuj_nowe_wyniki. Wyniki z ładowanego egzaminu w niej
obliczane względem wszystkich już załadowanych egzaminów. *W związku z tym ważne jest, aby egzaminy
w funkcji zaladuj_nowe_wyniki wprowadzane były chronologicznie - w przeciwnym razie część wyników może
się "zgubić" (np. gdy najpierw wprowadziliśmy wyniki z matury z języka polskiego 2015 bez wyników egzaminu
gimnazjalnego z j. polskiego 2012)*.

---

##UWAGA

Sumaryczne wyniki uczniów z poprzednich egzaminów obliczane są przez funkcję zaladuj_nowe_wyniki,
tę samą, która wypełnia ten zestaw danych. W związku z tym przetworzenie danych z jednego egzaminu bez
przetworzenia wcześniej danych egzaminów z lat poprzednich może sprawić, że w bazie będą niepełne dane.
Zawsze upewnij się, że egzaminy, w zależności od których chcesz prezentować wyniki testu znajdują się
już w bazie danych w sensownym zakresie lat.
